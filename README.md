...
On macOS you can also double-click `web/Run Mangosoft.command`. It launches Terminal, checks that `python3` is installed, starts the local server, and opens the app in your default browser while keeping the window open until you press `Ctrl + C`.
